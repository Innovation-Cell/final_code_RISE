...
void lidarCallback(const sensor_msgs::LaserScan::ConstPtr& msg)
{
    ...
    fused_local_map::customOccupancy laserGrid;
	...
	fused_local_map::custocc laserGrid1;
	...
	lane.data.clear();
	laserGrid.data.clear();
	laserGrid1.data.clear();
	map_req.data.clear();
	map.data.clear();
...
{
	ros::init(argc, argv, "fused_OccGrd");
	ros::NodeHandle n;
	ros::NodeHandle nh;
	ros::NodeHandle nh1;
	ros::NodeHandle nh2;
	...
	pub = n.advertise<fused_local_map::customOccupancy>("/scan/OccGrd", 1);
	pub1 = nh1.advertise<fused_local_map::custocc>("/scan/OccGrdfull", 1);
