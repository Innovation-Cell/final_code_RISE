...
int main(int argc, char* argv[]){
	...
	ros::Publisher gpslatlon = n.advertise<vectornav::vn200_msg>("/gps/fix", 1);
	...
	while(ros::ok()){	
		...
		/*Filling in Data*/
			...
			//Pose Data//
				...
				lat_lon.LLA.latitude = latitudeLongitudeAltitude.c0;
				lat_lon.LLA.longitude = latitudeLongitudeAltitude.c1;
				lat_lon.LLA.altitude = latitudeLongitudeAltitude.c2;
				gpslatlon.publish(lat_lon);
				fromMsg(forUTMConversion, UTMConverted);
